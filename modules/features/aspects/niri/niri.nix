{ inputs, self, ... }: {
  flake.wrappersModules.niri = { config, lib, pkgs, ... }: let
  ...
  in {
    ...
    config = {
      ...
      settings = {
        ...
        layout = {
          gaps = 5;
          shadow = { softness = 10; spread = 5; offset = _: { props = { x = 0; y = 5; }; }; };
          ...
          border = {
            width = 1;
            "active-gradient" = _: {
              props = { from = "#090E13"; to = "#1a1a1a"; angle = 45; relative-to = "workspace-view"; };
            };
          ...
          tab-indicator = {
            ...
            gaps-between-tabs = 2;
            corner-radius = 0;
            "active-gradient" = _: { props = { from = "#c4b28a"; to = "#c4746e"; angle = 45; }; };
            "inactive-gradient" = _: { props = { from = "#0d0c0c"; to = "#808080"; angle = 45; relative-to = "workspace-view"; }; };
            "urgent-gradient" = _: { props = { from = "#E46876"; to = "#c4746e"; angle = 45; }; };
          };
        };
        ...
        binds = {
          ...
          "Mod+S".spawn = [ noctaliaExe "msg" "panel-toggle" "launcher" ];
          "Mod+comma".spawn = [ noctaliaExe "msg" "launcher" "settings" ];
          "Mod+space".spawn = [ noctaliaExe "msg" "launcher" "command" ];
          "Mod+Escape".spawn = [ noctaliaExe "msg" "screen-lock" ];
          "Mod+P".spawn = [ noctaliaExe "msg" "panel-toggle" "session" ];
          "Mod+Alt+E".spawn = [ noctaliaExe "msg" "launcher" "emoji" ];
          "Mod+N".spawn = [ noctaliaExe "msg" "nightlight-enable" ];
          "Mod+Alt+N".spawn = [ noctaliaExe "msg" "nightlight-disable" ];
          "Mod+Shift+N".spawn = [ noctaliaExe "msg" "caffeine-toggle" ];
          ...
          # Multimedia & Hardware
          "XF86AudioRaiseVolume" = _: { props = { allow-when-locked = true; }; content = { spawn = [ "wpctl" "set-volume" "@DEFAULT_AUDIO_SINK@" "5%+" ]; }; };
          "XF86AudioLowerVolume" = _: { props = { allow-when-locked = true; }; content = { spawn = [ "wpctl" "set-volume" "@DEFAULT_AUDIO_SINK@" "5%-" ]; }; };
          ...
          "XF86MonBrightnessUp" = _: { props = { allow-when-locked = true; }; content = { spawn = [ "brightnessctl" "set" "+5%" ]; }; };
          "XF86MonBrightnessDown" = _: { props = { allow-when-locked = true; }; content = { spawn = [ "brightnessctl" "set" "5%-" ]; }; };
          "XF86AudioPlay" = _: { props = { allow-when-locked = true; }; content = { spawn = [ "playerctl" "play-pause" ]; }; };
          "XF86AudioNext" = _: { props = { allow-when-locked = true; }; content = { spawn = [ "playerctl" "next" ]; }; };
          "XF86AudioPrev" = _: { props = { allow-when-locked = true; }; content = { spawn = [ "playerctl" "previous" ]; }; };
          ...
          # App Launcher
          "Mod+d".spawn = [ (self.mkWhichKeyExe pkgs [
            ...
            { key = "y"; desc = "Tui fileManager"; cmd = "yazi"; }
            { key = "t"; desc = "Telegram"; cmd = "Telegram"; }
            { key = "d"; desc = "Discord"; cmd = "vesktop"; }
            { key = "m"; desc = "Youtube Music"; cmd = "pear-desktop"; }
            { key = "p"; desc = "Helium Browser"; cmd = "helium"; }
            { key = "s"; desc = "Pavucontrol"; cmd = "${lib.getExe pkgs.pavucontrol}"; }
          ]) ];
        };
      };
    };
