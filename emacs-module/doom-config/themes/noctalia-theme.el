...
(let* ((bg "#141314")
      ...
      (on-primary "#312f37")
      (on-primary-container "#504d56")
      (on-secondary "#313033")
      (on-secondary-container "#b8b4b8")
      (on-surface "#e6e1e2")
      (on-surface-variant "#c9c5cb")
      (on-tertiary "#382e32")
      (on-tertiary-container "#574c50")
      (outline-color "#938f95")
      (outline-variant "#48464b")
      (primary "#e0dbe5")
      (primary-container "#c4bfc9")
      (secondary "#c9c5c9")
      (secondary-container "#48464a")
      (shadow "#000000")
      (surface "#141314")
      ...
      (tertiary "#ead9de")
      (tertiary-container "#cdbdc2")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#ead9de")
      (on-success "#382e32")
      (success-container "#cdbdc2")
      (on-success-container "#574c50")
      ;; Map fixed colors to regular colors
      (primary-fixed "#e0dbe5")
      (primary-fixed-dim "#c4bfc9")
      (secondary-fixed "#c9c5c9")
      (secondary-fixed-dim "#48464a")
      (tertiary-fixed "#ead9de")
      (tertiary-fixed-dim "#cdbdc2")
      (on-primary-fixed "#312f37")
      (on-primary-fixed-variant "#504d56")
      (on-secondary-fixed "#313033")
      (on-secondary-fixed-variant "#b8b4b8")
      (on-tertiary-fixed "#382e32")
      (on-tertiary-fixed-variant "#574c50")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e6e1e2")
      (inverse-primary "#e0dbe5")
      (inverse-surface "#141314")
