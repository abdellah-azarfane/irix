...
(let* ((bg "#291c14")
      (err "#e18c56")
      (err-container "#7a360a")
      (on-background "#f3f2f2")
      (on-err "#251d18")
      (on-err-container "#f7e2d4")
      (on-primary "#251d18")
      (on-primary-container "#f7e2d4")
      (on-secondary "#251d18")
      (on-secondary-container "#f7f3d4")
      (on-surface "#f3f2f2")
      (on-surface-variant "#b6b2af")
      (on-tertiary "#251d18")
      (on-tertiary-container "#e9f7d4")
      (outline-color "#716761")
      (outline-variant "#73675e")
      (primary "#e49867")
      (primary-container "#8d3e0c")
      (secondary "#e1d256")
      (secondary-container "#7a6e0a")
      (shadow "#291c14")
      (surface "#291c14")
      (surface-container "#452f21")
      (surface-container-high "#3e2a1e")
      (surface-container-highest "#4c3425")
      (surface-container-low "#221811")
      (surface-container-lowest "#150e0a")
      (surface-variant "#37261b")
      (tertiary "#abe156")
      (tertiary-container "#4f7a0a")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#abe156")
      (on-success "#251d18")
      (success-container "#4f7a0a")
      (on-success-container "#e9f7d4")
      ;; Map fixed colors to regular colors
      (primary-fixed "#e49867")
      (primary-fixed-dim "#8d3e0c")
      (secondary-fixed "#e1d256")
      (secondary-fixed-dim "#7a6e0a")
      (tertiary-fixed "#abe156")
      (tertiary-fixed-dim "#4f7a0a")
      (on-primary-fixed "#251d18")
      (on-primary-fixed-variant "#f7e2d4")
      (on-secondary-fixed "#251d18")
      (on-secondary-fixed-variant "#f7f3d4")
      (on-tertiary-fixed "#251d18")
      (on-tertiary-fixed-variant "#e9f7d4")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f3f2f2")
      (inverse-primary "#e49867")
      (inverse-surface "#291c14")
