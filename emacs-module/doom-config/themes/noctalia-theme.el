...
(let* ((bg "#291d14")
      (err "#e67a32")
      (err-container "#622903")
      (on-background "#f3f2f2")
      (on-err "#251d18")
      (on-err-container "#f9e2d2")
      (on-primary "#251d18")
      (on-primary-container "#f9e2d2")
      (on-secondary "#251d18")
      (on-secondary-container "#f9f5d2")
      (on-surface "#f3f2f2")
      (on-surface-variant "#b6b2af")
      (on-tertiary "#251d18")
      (on-tertiary-container "#dae7f1")
      (outline-color "#716861")
      (outline-variant "#74675f")
      (primary "#ec9860")
      (primary-container "#953e05")
      (secondary "#e9d949")
      (secondary-container "#7b6f04")
      (shadow "#291d14")
      (surface "#291d14")
      (surface-container "#453021")
      (surface-container-high "#3e2b1e")
      (surface-container-highest "#4c3425")
      (surface-container-low "#221811")
      (surface-container-lowest "#150e0a")
      (surface-variant "#37261b")
      (tertiary "#89b7d8")
      (tertiary-container "#1e6190")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#89b7d8")
      (on-success "#251d18")
      (success-container "#1e6190")
      (on-success-container "#dae7f1")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ec9860")
      (primary-fixed-dim "#953e05")
      (secondary-fixed "#e9d949")
      (secondary-fixed-dim "#7b6f04")
      (tertiary-fixed "#89b7d8")
      (tertiary-fixed-dim "#1e6190")
      (on-primary-fixed "#251d18")
      (on-primary-fixed-variant "#f9e2d2")
      (on-secondary-fixed "#251d18")
      (on-secondary-fixed-variant "#f9f5d2")
      (on-tertiary-fixed "#251d18")
      (on-tertiary-fixed-variant "#dae7f1")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f3f2f2")
      (inverse-primary "#ec9860")
