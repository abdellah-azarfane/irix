...
(let* ((bg "#291e14")
      (err "#a85818")
      (err-container "#492204")
      (on-background "#f3f2f2")
      (on-err "#f8eee5")
      (on-err-container "#f9e3d2")
      (on-primary "#251e18")
      (on-primary-container "#f9e3d2")
      (on-secondary "#251e18")
      (on-secondary-container "#faf7d2")
      (on-surface "#f3f2f2")
      (on-surface-variant "#b6b2af")
      (on-tertiary "#251e18")
      (on-tertiary-container "#e8f9d2")
      (outline-color "#716961")
      (outline-variant "#73685e")
      (primary "#e99e63")
      (primary-container "#924407")
      (secondary "#e6dd4c")
      (secondary-container "#797306")
      (shadow "#291e14")
      (surface "#291e14")
      (surface-container "#453121")
      (surface-container-high "#3e2c1e")
      (surface-container-highest "#4c3625")
      (surface-container-low "#221911")
      (surface-container-lowest "#150f0a")
      (surface-variant "#37271b")
      (tertiary "#a1e64c")
      (tertiary-container "#467906")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#a1e64c")
      (on-success "#251e18")
      (success-container "#467906")
      (on-success-container "#e8f9d2")
      ;; Map fixed colors to regular colors
      (primary-fixed "#e99e63")
      (primary-fixed-dim "#924407")
      (secondary-fixed "#e6dd4c")
      (secondary-fixed-dim "#797306")
      (tertiary-fixed "#a1e64c")
      (tertiary-fixed-dim "#467906")
      (on-primary-fixed "#251e18")
      (on-primary-fixed-variant "#f9e3d2")
      (on-secondary-fixed "#251e18")
      (on-secondary-fixed-variant "#faf7d2")
      (on-tertiary-fixed "#251e18")
      (on-tertiary-fixed-variant "#e8f9d2")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f3f2f2")
      (inverse-primary "#e99e63")
      (inverse-surface "#291e14")
