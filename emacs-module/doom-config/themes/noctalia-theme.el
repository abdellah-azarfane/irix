...
(let* ((bg "#1a231b")
      ...
      (on-secondary "#18251a")
      (on-secondary-container "#e5e9e2")
      (on-surface "#f2f3f2")
      (on-surface-variant "#afb6b0")
      (on-tertiary "#18251a")
      (on-tertiary-container "#e4e7e7")
      (outline-color "#5f6f61")
      (outline-variant "#5c705f")
      (primary "#67e47b")
      (primary-container "#0c8d20")
      (secondary "#8bd65c")
      (secondary-container "#356f10")
      (shadow "#1a231b")
      (surface "#1a231b")
      (surface-container "#2b3b2e")
      (surface-container-high "#273529")
      (surface-container-highest "#304132")
      (surface-container-low "#161d17")
      (surface-container-lowest "#0d120e")
      (surface-variant "#232f24")
      (tertiary "#66bdcc")
      (tertiary-container "#165d69")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#66bdcc")
      (on-success "#18251a")
      (success-container "#165d69")
      (on-success-container "#e4e7e7")
      ;; Map fixed colors to regular colors
      (primary-fixed "#67e47b")
      (primary-fixed-dim "#0c8d20")
      (secondary-fixed "#8bd65c")
      (secondary-fixed-dim "#356f10")
      (tertiary-fixed "#66bdcc")
      (tertiary-fixed-dim "#165d69")
      (on-primary-fixed "#18251a")
      (on-primary-fixed-variant "#000000")
      (on-secondary-fixed "#18251a")
      (on-secondary-fixed-variant "#e5e9e2")
      (on-tertiary-fixed "#18251a")
      (on-tertiary-fixed-variant "#e4e7e7")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f2f3f2")
      (inverse-primary "#67e47b")
      (inverse-surface "#1a231b")
