...
(let* ((bg "#242c11")
      ...
      (on-secondary "#212518")
      (on-secondary-container "#dff1da")
      (on-surface "#f3f3f2")
      (on-surface-variant "#b4b6af")
      (on-tertiary "#212518")
      (on-tertiary-container "#daf1e1")
      (outline-color "#6f7464")
      (outline-variant "#6e7560")
      (primary "#bfe467")
      (primary-container "#678d0c")
      (secondary "#75d65c")
      (secondary-container "#246f10")
      (shadow "#242c11")
      (surface "#242c11")
      (surface-container "#3c4a1c")
      (surface-container-high "#364319")
      (surface-container-highest "#42511f")
      (surface-container-low "#1e250e")
      (surface-container-lowest "#121608")
      (surface-variant "#303b16")
      (tertiary "#66cc84")
      (tertiary-container "#16692f")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#66cc84")
      (on-success "#212518")
      (success-container "#16692f")
      (on-success-container "#daf1e1")
      ;; Map fixed colors to regular colors
      (primary-fixed "#bfe467")
      (primary-fixed-dim "#678d0c")
      (secondary-fixed "#75d65c")
      (secondary-fixed-dim "#246f10")
      (tertiary-fixed "#66cc84")
      (tertiary-fixed-dim "#16692f")
      (on-primary-fixed "#212518")
      (on-primary-fixed-variant "#000000")
      (on-secondary-fixed "#212518")
      (on-secondary-fixed-variant "#dff1da")
      (on-tertiary-fixed "#212518")
      (on-tertiary-fixed-variant "#daf1e1")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f3f3f2")
      (inverse-primary "#bfe467")
      (inverse-surface "#242c11")
