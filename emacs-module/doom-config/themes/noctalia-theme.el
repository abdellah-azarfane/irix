...
(let* ((bg "#19241c")
      (err "#fd4663")
      (err-container "#910017")
      (on-background "#f2f3f2")
      (on-err "#18251c")
      (on-err-container "#fecdd4")
      (on-primary "#18251c")
      (on-primary-container "#e1eae3")
      (on-secondary "#18251c")
      (on-secondary-container "#e1eae8")
      (on-surface "#f2f3f2")
      (on-surface-variant "#afb6b1")
      (on-tertiary "#141f18")
      (on-tertiary-container "#e1e8ea")
      (outline-color "#5c7061")
      (outline-variant "#5c7061")
      (primary "#67e488")
      (primary-container "#0c8d2e")
      (secondary "#5cd6bc")
      (secondary-container "#106f5b")
      (shadow "#19241c")
      (surface "#19241c")
      (surface-container "#293d2e")
      (surface-container-high "#25372a")
      (surface-container-highest "#2d4333")
      (surface-container-low "#151e17")
      (surface-container-lowest "#0c120e")
      (surface-variant "#213125")
      (tertiary "#66b1cc")
      (tertiary-container "#165369")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#66b1cc")
      (on-success "#141f18")
      (success-container "#165369")
      (on-success-container "#e1e8ea")
      ;; Map fixed colors to regular colors
      (primary-fixed "#67e488")
      (primary-fixed-dim "#0c8d2e")
      (secondary-fixed "#5cd6bc")
      (secondary-fixed-dim "#106f5b")
      (tertiary-fixed "#66b1cc")
      (tertiary-fixed-dim "#165369")
      (on-primary-fixed "#18251c")
      (on-primary-fixed-variant "#e1eae3")
      (on-secondary-fixed "#18251c")
      (on-secondary-fixed-variant "#e1eae8")
      (on-tertiary-fixed "#141f18")
      (on-tertiary-fixed-variant "#e1e8ea")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f2f3f2")
      (inverse-primary "#67e488")
      (inverse-surface "#19241c")
