...
(let* ((bg "#2b2e0f")
      ...
      (on-background "#f3f3f2")
      (on-err "#242518")
      (on-err-container "#fecdd4")
      (on-primary "#242518")
      (on-primary-container "#000000")
      (on-secondary "#242518")
      (on-secondary-container "#e3f4d7")
      (on-surface "#f3f3f2")
      (on-surface-variant "#b6b6af")
      (on-tertiary "#242518")
      (on-tertiary-container "#d7f4da")
      (outline-color "#747666")
      (outline-variant "#747661")
      (primary "#d8e467")
      (primary-container "#818d0c")
      (secondary "#8dd65c")
      (secondary-container "#366f10")
      (shadow "#2b2e0f")
      (surface "#2b2e0f")
      (surface-container "#484c1a")
      (surface-container-high "#404517")
      (surface-container-highest "#4f541c")
      (surface-container-low "#24260d")
      (surface-container-lowest "#151708")
      (surface-variant "#393d14")
      (tertiary "#61d16b")
      (tertiary-container "#136c1b")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#61d16b")
      (on-success "#242518")
      (success-container "#136c1b")
      (on-success-container "#d7f4da")
      ;; Map fixed colors to regular colors
      (primary-fixed "#d8e467")
      (primary-fixed-dim "#818d0c")
      (secondary-fixed "#8dd65c")
      (secondary-fixed-dim "#366f10")
      (tertiary-fixed "#61d16b")
      (tertiary-fixed-dim "#136c1b")
      (on-primary-fixed "#242518")
      (on-primary-fixed-variant "#000000")
      (on-secondary-fixed "#242518")
      (on-secondary-fixed-variant "#e3f4d7")
      (on-tertiary-fixed "#242518")
      (on-tertiary-fixed-variant "#d7f4da")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f3f3f2")
      (inverse-primary "#d8e467")
      (inverse-surface "#2b2e0f")
